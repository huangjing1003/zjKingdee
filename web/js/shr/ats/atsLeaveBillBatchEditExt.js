 ...
 * @author  hj
 */
shr.defineClass("shr.ats.AtsLeaveBillBatchEditExt", shr.ats.AtsLeaveBillBatchEdit, {
	/**
	 * 初始化
	 */
	initalizeDOM: function () {
		shr.ats.AtsLeaveBillBatchEditExt.superClass.initalizeDOM.call(this);
		var that = this;
	...
	leaveTicketTypeChange:function(){
		...
		$("#leaveTicketType").shrPromptBox("option", {
			onchange : function(e, value) {
				...
				var typeNanme = info.name;//名称
				//01和04为购买机票时，显示机票信息，获取的是ID字段
				//公司购买和改签机票出差

...
shr.defineClass("shr.custom.bizbill.DepCustomBillBnsLmtEditExt",shr.custom.bizbill.DepCustomBillEdit, {
	$editGrid : null,
	initalizeDOM : function () {
		shr.custom.bizbill.DepCustomBillBnsLmtEditExt.superClass.initalizeDOM.call(this);
		var _self = this;
...
//		}
	...
	doBeforeFillRowData : function(personId){
		...
		var annualSrdLmt = $("#annualSrdLmt").val();
		shr.callService({
			serviceName : "getPersonAnnlLimit",
			param :{
				personID: personId,

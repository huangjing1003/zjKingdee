 ...
 * output class name
 */
public abstract class AbstractWxtokenListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWxtokenListUI.class);
    /**
     * output class constructor
     */
    public AbstractWxtokenListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.ats.app.WxtokenListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.ats.client", "WxtokenListUI");
    }
